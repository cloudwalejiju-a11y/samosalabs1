...
echo "║                                                            ║"
echo "║   👨‍🏫 Brought to you by Cloud Wale Jija Ji's Cloud Tutorials     ║"
echo "║   📺 Subscribe: https://youtube.com/@cloudwalejijaji       ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
...
echo "║   ${CYAN}Subscribe to Cloud Wale Jija Ji's YouTube Channel      ${WHITE}     ║"
echo "║   ${CYAN}https://youtube.com/@cloudwalejijaji             ${WHITE}     ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo "${RESET}"
...
echo "${BOLD}${BLUE}https://youtube.com/@cloudwalejijaji${RESET}"
echo ""
