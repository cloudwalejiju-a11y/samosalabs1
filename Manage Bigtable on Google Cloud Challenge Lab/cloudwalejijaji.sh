...
echo "${CYAN}${BOLD}       Welcome to Cloud Wale Jija Ji Cloud Tutorials!           ${RESET}"
echo "${CYAN}${BOLD}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${GREEN}${BOLD}Please like, share and subscribe to the channel for more:${RESET}"
echo "${BLUE}${BOLD}https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
...
while true; do
    ...
    if [ $? -eq 0 ]; then
        echo "${YELLOW}${BOLD}Job has completed successfully. Now just wait for succeeded${RESET} ${BLUE}${BOLD}https://www.youtube.com/@cloudwalejijaji${RESET}"
        break
    else
        echo "${YELLOW}${BOLD}Job retrying. Please like, share and subscribe to Cloud Wale Jija Ji Cloud Tutorials${RESET} ${BLUE}${BOLD}https://www.youtube.com/@cloudwalejijaji${RESET}"
        sleep 10
    fi
done
