...
echo "${BG_BLUE}${BOLD}${WHITE}   Welcome to Cloud Wale Jija Ji's Cloud Lab Setup Script        ${RESET}"
echo "${BG_BLUE}${BOLD}${WHITE}╚════════════════════════════════════════════════════════╝${RESET}"
echo
...
echo "${BG_GREEN}${BOLD}${BLACK}╚════════════════════════════════════════════════════════╝${RESET}"
echo
echo "${MAGENTA}${BOLD}Thank you for using Cloud Wale Jija Ji's Cloud Lab Setup Script${RESET}"
