...
function random_question() {
    QUESTIONS=(
        "Have you subscribed to Cloud Wale Jija Ji's YouTube channel yet? [Y/N]"
        "Did you hit the subscribe button on Cloud Wale Jija Ji's YouTube channel? [Y/N]"
        "Are you part of Cloud Wale Jija Ji's growing community on YouTube? [Y/N]"
        "Did you join the learning journey by subscribing to Cloud Wale Jija Ji? [Y/N]"
        "Have you clicked the subscribe button for Cloud Wale Jija Ji's tutorials? [Y/N]"
        "Are you a subscriber to Cloud Wale Jija Ji's YouTube channel? [Y/N]"
        "Want to stay updated with Cloud Wale Jija Ji's latest content? Subscribe now! [Y/N]"
        "Ready to dive deeper into cloud computing with Cloud Wale Jija Ji? Subscribe! [Y/N]"
        "Would you like to keep learning with Cloud Wale Jija Ji? Hit subscribe! [Y/N]"
        "Do you enjoy Cloud Wale Jija Ji's content? Subscribe to stay updated! [Y/N]"
        "Do you want to see more labs and tutorials from Cloud Wale Jija Ji? Subscribe to the channel! [Y/N]"
    )
...
function random_subscribe_message() {
    MESSAGES=(
        "${BOLD}${RED}Please ${GREEN}Subscribe ${YELLOW}to ${BLUE}Dr ${MAGENTA}Cloud Wale Jija Ji ${CYAN}Cloud Tutorial!${RESET}"
        "${BOLD}${CYAN}Don't miss out! Subscribe to ${MAGENTA}Dr ${GREEN}Cloud Wale Jija Ji ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Hit that subscribe button for more amazing content from ${CYAN}Dr ${GREEN}Cloud Wale Jija Ji ${MAGENTA}Cloud Tutorial!${RESET}"
        "${BOLD}${YELLOW}Join the ${GREEN}Dr ${CYAN}Cloud Wale Jija Ji ${MAGENTA}Cloud Tutorial community! Subscribe now!${RESET}"
        "${BOLD}${BLUE}Want more tutorials? ${MAGENTA}SUBSCRIBE ${YELLOW}to ${CYAN}Dr ${GREEN}Cloud Wale Jija Ji ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Your subscription helps us bring more tutorials to you! Please ${CYAN}subscribe to ${MAGENTA}Dr ${GREEN}Cloud Wale Jija Ji ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${YELLOW}Subscribe to ${CYAN}Dr ${MAGENTA}Cloud Wale Jija Ji ${GREEN}Cloud Tutorial to stay updated on all our tutorials!${RESET}"
        "${BOLD}${CYAN}Keep learning with us! ${GREEN}Subscribe to ${MAGENTA}Dr ${YELLOW}Cloud Wale Jija Ji ${RED}Cloud Tutorial!${RESET}"
        "${BOLD}${MAGENTA}Support us and get access to exclusive tutorials by subscribing to ${CYAN}Dr ${GREEN}Cloud Wale Jija Ji ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${BLUE}Love the content? Subscribe to ${MAGENTA}Dr ${CYAN}Cloud Wale Jija Ji ${GREEN}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Help us grow by subscribing to ${CYAN}Dr ${MAGENTA}Cloud Wale Jija Ji ${YELLOW}Cloud Tutorial! Your support is crucial!${RESET}"
        "${BOLD}${GREEN}Don't forget to hit subscribe to stay up to date with ${CYAN}Dr ${MAGENTA}Cloud Wale Jija Ji ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${YELLOW}Want to join the ${BLUE}Dr ${MAGENTA}Cloud Wale Jija Ji ${CYAN}Cloud Tutorial family? Hit subscribe!${RESET}"
        "${BOLD}${MAGENTA}We appreciate your support! Please ${CYAN}subscribe to ${GREEN}Dr ${RED}Cloud Wale Jija Ji ${BLUE}Cloud Tutorial!${RESET}"
        "${BOLD}${CYAN}Your subscription makes a difference! Help us grow by subscribing to ${MAGENTA}Dr ${YELLOW}Cloud Wale Jija Ji ${GREEN}Cloud Tutorial!${RESET}"
        "${BOLD}${RED}Every click counts! Please subscribe to ${BLUE}Dr ${MAGENTA}Cloud Wale Jija Ji ${CYAN}Cloud Tutorial!${RESET}"
    )
    RANDOM_INDEX=$((RANDOM % ${#MESSAGES[@]}))
    echo -e "${BOLD}${MESSAGES[$RANDOM_INDEX]}"
}
...
case "${CHOICE^^}" in
    ...
    N)
        ...
        echo -e "${BOLD}${CYAN}YouTube Channel: https://www.youtube.com/@cloudwalejijaji${RESET}"
        echo -e "${BOLD}${GREEN}Check out all videos at: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
        ;;
    *)
