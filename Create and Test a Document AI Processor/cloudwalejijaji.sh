...
# Final message
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji Cloud Tutorial:${RESET_FORMAT} ${MAGENTA_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
