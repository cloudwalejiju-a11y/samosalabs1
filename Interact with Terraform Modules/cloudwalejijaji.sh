...
echo "${BG_MAGENTA}${BOLD}============================================${RESET}"
echo "${BLUE}YouTube Channel: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo "${CYAN}Video Tutorials: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
...
curl -s -O https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Interact%20with%20Terraform%20Modules/index.html || {
  echo "${YELLOW}⚠️ Failed to download index.html${RESET}"
}

curl -s -O https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Interact%20with%20Terraform%20Modules/error.html || {
...
echo "${CYAN}Subscribe to Cloud Wale Jija Ji's YouTube Channel:${RESET}"
echo "${YELLOW}https://www.youtube.com/@cloudwalejijaji${RESET}"
