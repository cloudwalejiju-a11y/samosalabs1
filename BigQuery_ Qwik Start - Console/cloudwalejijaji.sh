...
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${BLUE_TEXT}${BOLD_TEXT}          Tutorial by Cloud Wale Jija Ji                       ${RESET_FORMAT}"
echo "${YELLOW_TEXT}For more BigQuery tutorials, visit: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji's Channel:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
