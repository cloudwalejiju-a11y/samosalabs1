...
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to Cloud Wale Jija Ji: https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
...
gcloud artifacts repositories create $REPO \
  ...
  --location=$REGION \
  --description="Cloud Wale Jija Ji"
...
git add .
git commit -m "Cloud Wale Jija Ji" 
