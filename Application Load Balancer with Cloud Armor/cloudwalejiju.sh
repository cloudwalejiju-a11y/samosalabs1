...
stop_spinner() {
    ...
    printf " %s\n" "${GREEN_TEXT}${BOLD_TEXT}✔ Done! Subscribe to Cloud Wale Jiju ❤️${RESET_FORMAT}"
}

echo
echo "${CYAN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}   CLOUD WALE JIJU SUBSCRIBE FOR MORE     ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Welcome to Cloud Wale Jiju Cloud Tutorials${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}Subscribe for more cloud content: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo