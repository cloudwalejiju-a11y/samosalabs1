...
stop_spinner() {
    ...
    printf " %s\n" "${GREEN_TEXT}${BOLD_TEXT}✔ Done! Subscribe to Cloud Wale Jija Ji ❤️${RESET_FORMAT}"
}
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Welcome to Cloud Wale Jija Ji Cloud Tutorials${RESET_FORMAT}"
