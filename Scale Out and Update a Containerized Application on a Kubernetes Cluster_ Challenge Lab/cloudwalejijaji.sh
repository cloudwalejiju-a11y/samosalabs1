...
clear
echo "${BG_MAGENTA}${BOLD}Welcome to Cloud Wale Jija Ji Cloud Tutorials${RESET}"
echo "${CYAN}Subscribe to the channel: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
...
echo
echo "${MAGENTA}${BOLD}Don't forget to subscribe to Cloud Wale Jija Ji's channel:${RESET}"
echo "${BLUE}https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
