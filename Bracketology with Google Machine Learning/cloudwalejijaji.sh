...
echo -e "${GREEN_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji's YouTube Channel:${RESET_FORMAT}"
echo -e "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
