...
echo "${YELLOW_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}👉 https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}🙏 Thanks for Learning with Cloud Wale Jija Ji!${RESET_FORMAT}"
