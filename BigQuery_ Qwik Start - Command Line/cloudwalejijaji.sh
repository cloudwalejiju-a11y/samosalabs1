...
wget https://github.com/cloudwalejiju-a11y/samosalabs1/raw/refs/heads/main/BigQuery:%20Qwik%20Start%20-%20Command%20Line/names.zip
...
echo -e "${BOLD_WHITE}${BG_BLUE}════════════════════════════════════════${RESET}"
echo ""
echo -e "${BOLD_CYAN}For more tutorials, visit: ${UNDERLINE}https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo ""
