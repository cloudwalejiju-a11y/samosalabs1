...
echo "${RED_TEXT}${BOLD_TEXT}YouTube: https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Subscribe to Cloud Wale Jija Ji's Channel: https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
