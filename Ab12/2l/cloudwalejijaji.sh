...
# Welcome to Cloud Wale Jija Ji Cloud Tutorials!
# YouTube: https://www.youtube.com/@cloudwalejijaji/videos
# ==============================================
...
echo "=================================================================="
echo " YouTube Channel: https://www.youtube.com/@cloudwalejijaji/videos"
echo "=================================================================="
...
echo "${BLUE}🌐 YouTube: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo "${BLUE}==================================================================${RESET}"
