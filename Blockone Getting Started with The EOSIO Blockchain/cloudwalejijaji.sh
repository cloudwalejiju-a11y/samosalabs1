#!/bin/bash
# Cloud Wale Jija Ji's EOSIO Blockchain Deployment Script
...
clear
echo -e "${BOX_TOP}"
echo -e "${CYAN}║   🚀 Cloud Wale Jija Ji's EOSIO Blockchain Lab   ║${RESET}"
echo -e "${BOX_BOT}"
echo
...
echo -e "╚════════════════════════════════════════════╝${RESET}"
echo -e "${WHITE}Thank you for using Cloud Wale Jija Ji's Blockchain Lab!${RESET}"
