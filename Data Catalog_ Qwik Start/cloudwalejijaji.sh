...
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Tutorial by Cloud Wale Jija Ji${RESET_FORMAT}"
echo "${CYAN_TEXT}For more GCP tutorials, visit: ${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo ""
echo "${RED_TEXT}${BOLD_TEXT}Special thanks to Cloud Wale Jija Ji for this tutorial!${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji's YouTube channel for more GCP content:${RESET_FORMAT}"
