...
# Welcome Message
echo -e "${YELLOW}--------------------------------------------------------"
echo -e "${GREEN}🎓 Welcome to Cloud Wale Jija Ji's Cloud Tutorials! ☁️"
echo -e "${CYAN}Subscribe to the channel: https://www.youtube.com/@cloudwalejijaji/videos"
echo -e "${YELLOW}--------------------------------------------------------${NC}"
...
curl -LO raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Google%20Kubernetes%20Engine%20Pipeline%20using%20Cloud%20Build/env-cloudbuild.yaml
...
curl -LO raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Google%20Kubernetes%20Engine%20Pipeline%20using%20Cloud%20Build/app-cloudbuild.yaml
...
echo -e "${CYAN}🙏 Thanks for using Cloud Wale Jija Ji's Cloud Tutorials!"
echo -e "${YELLOW}👉 Subscribe here: ${NC}https://www.youtube.com/@cloudwalejijaji/videos"
