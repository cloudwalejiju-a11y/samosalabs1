...
welcome_message() {
    ...
    echo "╔════════════════════════════════════════════════════════════════════╗"
    echo "║                                                                    ║"
    echo "║        WELCOME TO Cloud Wale Jija Ji Cloud Tutorials Do Like & SUB         ║"
    echo "║                                                                    ║"
    ...
    echo
    echo "${CYAN}For more tutorials, visit: https://www.youtube.com/@cloudwalejijaji${RESET}"
    echo
...
wget https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Introduction%20to%20Computer%20Vision%20with%20TensorFlow/model.ipynb
wget https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Introduction%20to%20Computer%20Vision%20with%20TensorFlow/callback_model.ipynb
wget https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Introduction%20to%20Computer%20Vision%20with%20TensorFlow/updated_model.ipynb
echo
...
echo "${MAGENTA}For more tutorials, subscribe to: https://www.youtube.com/@cloudwalejijaji${RESET}"
