...
section_header() {
    ...
    echo "${BG_BLUE}${BOLD}${WHITE}  Welcome to Cloud Wale Jija Ji Cloud Tutorials Do like the video  $1${RESET}"
    echo "${BG_BLUE}${BOLD}${WHITE}╚════════════════════════════════════════════════════════╝${RESET}"
    echo
}
...
# Welcome message
clear
section_header "Cloud Wale Jija Ji's Network Lab Setup"
echo "${GREEN}${BOLD}This script will configure a custom GCP network environment${RESET}"
echo "${CYAN}For more cloud tutorials, visit: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo
...
echo "${BG_GREEN}${BOLD}${BLACK}Congratulations on completing Cloud Wale Jija Ji's Network Lab!${RESET}"
echo
echo "${MAGENTA}${BOLD}For more cloud computing tutorials and labs:${RESET}"
echo "${CYAN}${BOLD}Subscribe to Cloud Wale Jija Ji's YouTube channel:${RESET}"
