...
echo "${CYAN_TEXT}${BOLD_TEXT}🚀   Cloud Wale Jija Ji Cloud Tutorials - Lab  🚀${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=========================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
