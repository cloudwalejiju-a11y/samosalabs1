...
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}*                    Welcome to Cloud Wale Jija Ji Cloud Tutorials                    *${RESET}"
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}*  Subscribe to our YouTube Channel: https://www.youtube.com/@cloudwalejijaji  *${RESET}"
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}********************************************************************************${RESET}"
echo ""
...
echo "${BG_BLUE}${BOLD}********************************************************************************${RESET}"
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}*  Thank you for using Cloud Wale Jija Ji Cloud Tutorials!                           *${RESET}"
echo "${BG_BLUE}${BOLD}*  Don't forget to subscribe: https://www.youtube.com/@cloudwalejijaji         *${RESET}"
echo "${BG_BLUE}${BOLD}*                                                                              *${RESET}"
echo "${BG_BLUE}${BOLD}********************************************************************************${RESET}"
