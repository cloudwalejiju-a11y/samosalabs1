...
function show_banner() {
    ...
    echo "${BLUE_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
...
echo "${WHITE_TEXT}- For more tutorials, subscribe to Cloud Wale Jija Ji's channel:"
echo "${BLUE_TEXT}  https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
