...
echo "${RANDOM_BG_COLOR}${RANDOM_TEXT_COLOR}${BOLD}Welcome to Cloud Wale Jija Ji Cloud Tutorials${RESET}"
...
echo "${BOLD}${CYAN}Thank you for using Cloud Wale Jija Ji Cloud Tutorials${RESET}"
