...
curl -s -LO https://github.com/cloudwalejiju-a11y/samosalabs1/blob/9cf40ec8a380bbe71712daeb0a172d8844a2787f/Use%20APIs%20to%20Work%20with%20Cloud%20Storage%3A%20Challenge%20Lab/world.jpeg
...
echo "${SUCCESS_COLOR}${BOLD}╚════════════════════════════════════════╝${RESET}"
echo
echo "${INFO_COLOR}For more tutorials, visit: ${ACTION_COLOR}https://www.youtube.com/@cloudwalejijaji${RESET}"
echo
