...
echo "${BLUE_TEXT}${BOLD_TEXT}    Welcome to   Cloud Wale Jija Ji Cloud Tutorials     ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Thank you for using Cloud Wale Jija Ji Cloud Tutorials!${RESET_FORMAT}"
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}For more cloud tutorials and labs, visit:${RESET_FORMAT}"
echo "${CYAN_TEXT}https://www.youtube.com/@DrCloud Wale Jija JiCloudTutorials${RESET_FORMAT}"
echo
