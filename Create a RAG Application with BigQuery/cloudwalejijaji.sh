...
╚═╝     ╚═╝  ╚═╝      ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝
EOF
  echo -e "${CLR_ACCENT}Welcome to Cloud Wale Jija Ji Cloud Tutorials!${CLR_RESET}"
  echo
  echo -e "👉 ${CLR_WARN}Subscribe to the channel:${CLR_RESET} https://www.youtube.com/@cloudwalejijaji/videos"
  echo
}
...
echo -e \"${CLR_OK}All done!${CLR_RESET} 🚀  Don't forget to subscribe: ${CLR_ACCENT}https://www.youtube.com/@cloudwalejijaji/videos${CLR_RESET}\"
"
