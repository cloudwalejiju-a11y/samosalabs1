...
echo "${MAGENTA_TEXT}${BOLD_TEXT}Welcome to Cloud Wale Jija Ji's BigQuery ML Lab Setup${RESET_FORMAT}"
echo "${CYAN_TEXT}For more cloud ML tutorials: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}💖 If you found this helpful, subscribe to Cloud Wale Jija Ji's channel:${RESET_FORMAT}"
