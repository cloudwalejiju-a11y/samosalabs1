...
echo "${NEON_GREEN}${BOLD}https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
sleep 2
...
echo 'Page served from: $region1 - Cloud Wale Jija Ji' > /var/www/html/index.html
...
apt-get update -y
apt-get install apache2 -y
echo 'Page served from: $region2 - Cloud Wale Jija Ji' > /var/www/html/index.html
systemctl restart apache2" >/dev/null 2>&1 &
