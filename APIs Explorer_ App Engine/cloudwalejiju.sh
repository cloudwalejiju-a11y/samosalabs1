...
echo "${CYAN}${BOLD}   CLOUD WALE JIJU'S APP ENGINE DEPLOYMENT LAB ${RESET}"
echo "${CYAN}${BOLD}============================================${RESET}"
echo "${BLUE}YouTube Channel: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo "${CYAN}Video Tutorials: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo
...
echo "${CYAN}Subscribe to Cloud Wale Jiju's YouTube Channel:${RESET}"
