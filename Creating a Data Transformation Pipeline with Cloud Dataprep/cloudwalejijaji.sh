...
# Welcome message
echo "${MAGENTA_TEXT}${BOLD_TEXT}Welcome to Cloud Wale Jija Ji's Dataprep Lab Setup${RESET_FORMAT}"
echo "${CYAN_TEXT}For more data engineering tutorials: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo

# Create ecommerce dataset
echo "${GREEN_TEXT}${BOLD_TEXT}Creating ecommerce dataset...${RESET_FORMAT}"
bq mk ecommerce
echo "${CYAN_TEXT}${BOLD_TEXT}Subscribe for more tutorials: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}https://github.com/cloudwalejiju-a11y/samosalabs1/raw/refs/heads/main/Creating%20a%20Data%20Transformation%20Pipeline%20with%20Cloud%20Dataprep/flow_Ecommerce_Analytics_Pipeline.zip${RESET_FORMAT}"
