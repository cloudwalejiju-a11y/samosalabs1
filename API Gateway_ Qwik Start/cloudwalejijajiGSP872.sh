...
echo "${BLUE_TEXT}${BOLD_TEXT}  Welcome to Cloud Wale Jija Ji's Cloud Lab  ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${CYAN_TEXT}Please like, share and subscribe to:${RESET_FORMAT}"
echo "${MAGENTA_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
