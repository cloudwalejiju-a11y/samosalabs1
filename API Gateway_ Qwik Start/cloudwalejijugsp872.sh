...
echo "${BLUE_TEXT}${BOLD_TEXT}  Welcome to Cloud Wale Jiju's Cloud Lab  ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${CYAN_TEXT}Please like, share and subscribe to:${RESET_FORMAT}"
echo "${MAGENTA_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}Cloud Wale Jiju's YouTube Channel${RESET_FORMAT}"
echo "${MAGENTA_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo