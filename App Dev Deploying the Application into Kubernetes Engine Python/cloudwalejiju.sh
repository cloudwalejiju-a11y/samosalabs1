...
# Welcome message with Cloud Wale Jiju reference
echo "${CYAN_TEXT}${BOLD_TEXT}=============================================${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}    WELCOME TO CLOUD WALE JIJU CLOUD TUTORIALS   ${RESET_FORMAT}"
...
# Final message with Cloud Wale Jiju references
echo
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}        KUBERNETES ENGINE LAB COMPLETED SUCCESSFULLY!  ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Welcome to Cloud Wale Jiju Cloud Tutorials${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Thank you for following Cloud Wale Jiju Cloud Tutorials!${RESET_FORMAT}"
