...
subscribe_message() {
    ...
    echo "${YELLOW_TEXT}${BOLD_TEXT}🔥 Subscribe to Cloud Wale Jija Ji for More Labs${RESET_FORMAT}"
    echo "${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
    echo "${MAGENTA_TEXT}${BOLD_TEXT}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET_FORMAT}"
    echo
}
...
"Subscribe to Cloud Wale Jija Ji 🔥"
...
echo
echo "🔥 Subscribe to Cloud Wale Jija Ji"
...
print("\n🔥 Subscribe to Cloud Wale Jija Ji")
print("https://www.youtube.com/@cloudwalejijaji\n")
