...
echo "${CYAN_TEXT}${BOLD_TEXT}       Welcome to Cloud Wale Jija Ji's Cloud Tutorial          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}Subscribe to my channel: https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
...
gcloud artifacts repositories create my-repository \
    ...
    --location=$REGION \
    --description="Docker repository by Cloud Wale Jija Ji"
echo "${GREEN_TEXT}${BOLD_TEXT}╔════════════════════════════════════════════════════════╗${RESET_FORMAT}"
...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe to my channel:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
