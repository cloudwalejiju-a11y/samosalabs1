...
#  Created by Cloud Wale Jiju Cloud Tutorials
# ==============================================
...
echo "${BG_BLUE}${STYLE_BOLD}${FG_WHITE}  welcome to cloud wale jiju cloud guide       ${FORMAT_RESET}"
echo "${BG_BLUE}${STYLE_BOLD}${FG_WHITE}════════════════════════════════════════════${FORMAT_RESET}"
echo
...
echo "${COLOR_BLUE}https://www.youtube.com/@cloudwalejijaji${FORMAT_RESET}"
echo