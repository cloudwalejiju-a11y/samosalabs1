...
header() {
    ...
    echo "${BG_MAGENTA}${BOLD}${WHITE}  Cloud Wale Jija Ji's BigQuery ML Vector Search Lab  ${RESET}"
    echo "${BG_MAGENTA}${BOLD}${WHITE}================================================${RESET}"
    echo
}
...
welcome() {
    ...
    echo "${YELLOW}Subscribe to my channel: https://www.youtube.com/@cloudwalejijaji${RESET}"
    echo
