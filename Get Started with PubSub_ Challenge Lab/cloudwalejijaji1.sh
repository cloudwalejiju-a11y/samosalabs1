...
echo "${CYAN_TEXT}${BOLD_TEXT}     🚀 Welcome to Cloud Wale Jija Ji Cloud Tutorials – GCP Lab      ${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}==============================================================${RESET_FORMAT}"
echo
...
echo -e "${WHITE_TEXT}${BOLD_TEXT}📺 Follow Cloud Wale Jija Ji for more Cloud Labs:${RESET_FORMAT} ${CYAN_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
