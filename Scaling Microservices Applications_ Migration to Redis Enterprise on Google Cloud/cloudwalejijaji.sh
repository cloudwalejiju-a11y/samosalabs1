...
# Welcome message
echo "=================================================="
echo "Welcome to Cloud Wale Jija Ji Cloud Tutorial!"
echo "Subscribe to the channel: https://www.youtube.com/@cloudwalejijaji/videos"
echo "=================================================="
echo ""
...
echo "Thank you for following Cloud Wale Jija Ji Cloud Tutorial!"
echo "Don't forget to subscribe: https://www.youtube.com/@cloudwalejijaji/videos"
echo "=================================================="
