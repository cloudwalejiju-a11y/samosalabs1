...
cat > package.json <<EOF_CP
{
  ...
  "keywords": [],
  "author": "Cloud Wale Jija Ji Cloud Tutorials",
  "license": "ISC",
  "dependencies": {
...
echo "${MAGENTA_TEXT}${BOLD_TEXT}║                                                              ║${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}║    Thank you for using Cloud Wale Jija Ji Cloud Tutorials!        ║${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}║                                                              ║${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}╚══════════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${CYAN_TEXT}${BOLD_TEXT}For more cloud engineering tutorials and courses:${RESET_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}   📚 Visit: https://www.youtube.com/@cloudwalejijaji/${RESET_FORMAT}"
echo
