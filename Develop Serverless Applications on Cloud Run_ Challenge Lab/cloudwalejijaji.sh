...
echo "${YELLOW_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo "${BLUE_TEXT}YouTube: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo "${CYAN_TEXT}Tutorials: https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}Cloud Wale Jija Ji's YouTube Channel:${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo "${CYAN_TEXT}Video Tutorials: https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
