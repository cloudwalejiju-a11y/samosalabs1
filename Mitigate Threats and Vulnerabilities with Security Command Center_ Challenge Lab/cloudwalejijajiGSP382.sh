...
curl -LO raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Mitigate%20Threats%20and%20Vulnerabilities%20with%20Security%20Command%20Center%3A%20Challenge%20Lab/findings.jsonl
...
echo
echo -e "${RED_TEXT}${BOLD_TEXT}For more tutorials, visit Cloud Wale Jija Ji Cloud Tutorial:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
