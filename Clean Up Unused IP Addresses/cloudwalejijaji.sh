...
echo "${BG_BLUE}${WHITE}${BOLD}        🚀 Welcome to Cloud Wale Jija Ji Tutorial 🚀        ${RESET}"
...
echo "${BG_RED}${WHITE}${BOLD}  🔔 Subscribe to Cloud Wale Jija Ji Tutorial on YouTube 🔔 ${RESET}"
echo "${BG_RED}${WHITE}${BOLD}  https://www.youtube.com/@cloudwalejijaji/videos     ${RESET}"
echo "${BG_RED}${WHITE}${BOLD}=====================================================${RESET}"
echo ""
