...
# ❤️ Subscribe to Cloud Wale Jija Ji agye copy krne 
# 📺 https://www.youtube.com/@cloudwalejijaji/videos
# ============================================================
...
echo "${CYAN_TEXT}${BOLD_TEXT}============================================================${RESET_FORMAT}"
echo
echo "${YELLOW_TEXT}${BOLD_TEXT}📢 Subscribe to Cloud Wale Jija Ji ❤️${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
