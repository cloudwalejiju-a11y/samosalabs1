...
echo "${BLUE_TEXT}${BOLD_TEXT}      Cloud Wale Jija Ji Cloud Tutorials - NLP Lab    ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}https://www.youtube.com/@cloudwalejijaji/videos{RESET_FORMAT}"
echo
