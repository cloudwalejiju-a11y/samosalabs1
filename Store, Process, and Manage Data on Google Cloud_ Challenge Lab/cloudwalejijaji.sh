...
echo "${MAGENTA_TEXT}${BOLD_TEXT}*  Thank you for using Cloud Wale Jija Ji's Cloud Tutorial! *${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}*******************************************************${RESET_FORMAT}"
echo
echo "${BLUE_TEXT}${BOLD_TEXT}Don't forget to subscribe to Cloud Wale Jija Ji's YouTube channel:${RESET_FORMAT}"
