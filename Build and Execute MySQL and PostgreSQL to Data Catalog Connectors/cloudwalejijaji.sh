...
# Display Cloud Wale Jija Ji's branding header
echo "${CYAN}${BOLD}================================================${RESET}"
echo "${CYAN}${BOLD}   DR. ABHISHEK'S DATA CATALOG MIGRATION LAB   ${RESET}"
echo "${CYAN}${BOLD}================================================${RESET}"
echo "${BLUE}YouTube: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo "${MAGENTA}Tutorials: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
...
echo "${CYAN}YouTube: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo "${CYAN}Tutorials: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
