...
echo
echo "${RED_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji Cloud Tutorials:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji/${RESET_FORMAT}"
