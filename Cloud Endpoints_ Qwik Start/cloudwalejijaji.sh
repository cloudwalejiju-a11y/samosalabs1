...
echo "${BLUE_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Cloud Tutorial by Cloud Wale Jija Ji${RESET_FORMAT}"
...
echo "${GREEN_TEXT}${BOLD_TEXT}=======================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}DO like share & subscribe Cloud Wale Jija Ji for this tutorial!${RESET_FORMAT}"
