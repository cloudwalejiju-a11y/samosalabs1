#!/bin/bash
# Cloud Wale Jija Ji's Jenkins on GKE Deployment Script
...
echo "${BOX_MID}"
echo "  🚀 Cloud Wale Jija Ji's Jenkins CD on GKE Setup  "
echo "${BOX_MID}"
echo "${BOX_BOT}${RESET}"
echo
echo "${WHITE}📺 YouTube: ${BLUE}https://youtube.com/@cloudwalejijaji${RESET}"
...
echo "${BOX_BOT}${RESET}"
echo
echo "${WHITE}Thank you for using Cloud Wale Jija Ji's deployment script!${RESET}"
echo "${YELLOW}Don't forget to subscribe: ${BLUE}https://youtube.com/@cloudwalejijaji${RESET}"
echo
