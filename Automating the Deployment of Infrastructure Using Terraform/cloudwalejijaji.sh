...
wget -q https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/provider.tf
wget -q https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/terraform.tfstate
wget -q https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/variables.tf
wget -q https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/mynetwork.tf

# Create instance directory and download main.tf
mkdir -p instance
cd instance
wget -q https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Automating%20the%20Deployment%20of%20Infrastructure%20Using%20Terraform/main.tf
cd ..
...
echo "${CYAN}${BOLD}Remember to subscribe to Cloud Wale Jija Ji's YouTube channel:${RESET}"
echo "${BLUE}${BOLD}https://www.youtube.com/@cloudwalejijaji${RESET}"
