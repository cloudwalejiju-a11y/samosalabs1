...
echo -e "${BOLD}${GREEN}Welcome to Cloud Wale Jija Ji Cloud Tutorials!${RESET}"
echo -e "${BOLD}${CYAN}Subscribe to the channel:${RESET} https://www.youtube.com/@cloudwalejijaji/videos"
echo -e "${BOLD}${CYAN}==============================================${RESET}"
