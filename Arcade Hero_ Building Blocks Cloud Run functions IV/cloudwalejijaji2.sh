...
echo "${CYAN_TEXT}${BOLD_TEXT}         Welcome To Cloud Wale Jija Ji Cloud Tutorials       ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${UNDERLINE_TEXT}Subscribe to Cloud Wale Jija Ji's YouTube Channel${RESET_FORMAT}"
echo "${BLUE_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
