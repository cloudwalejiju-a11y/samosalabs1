...
echo -e "${MAROON_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji's Channel:${RESET_FORMAT} ${NAVY_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
