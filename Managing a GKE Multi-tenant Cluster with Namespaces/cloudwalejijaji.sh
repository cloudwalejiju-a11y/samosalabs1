...
echo "${BLUE}For tutorial videos, visit: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
...
echo "${BLUE}${BOLD}Subscribe to Cloud Wale Jija Ji's YouTube Channel:${RESET}"
echo "${CYAN}https://www.youtube.com/@cloudwalejijaji${RESET}"
echo "${BLUE}${BOLD}Video Tutorials:${RESET}"
echo "${CYAN}https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
