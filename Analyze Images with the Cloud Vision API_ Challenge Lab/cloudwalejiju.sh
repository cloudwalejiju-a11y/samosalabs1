...
echo "${BLUE}${BOLD}        WELCOME TO CLOUD WALE JIJU CLOUD TUTORIALS        ${RESET}"
echo "${BLUE}${BOLD}============================================${RESET}"
echo ""
echo "${CYAN}${BOLD}⚡ Expertly crafted by Cloud Wale Jiju Cloud${RESET}"
echo "${YELLOW}${BOLD}📺 YouTube: ${UNDERLINE}https://www.youtube.com/@DrCloud Wale JijuCloud${RESET}"
echo ""
...
echo "${YELLOW}${BOLD}👉 ${UNDERLINE}https://www.youtube.com/@cloudwalejijaji${RESET}"
