...
echo "${MAGENTA_TEXT}${BOLD_TEXT}Cloud Wale Jija Ji – Subscribe Here: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Watch more cloud tutorials on Cloud Wale Jija Ji's channel: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
...
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Support the channel: Cloud Wale Jija Ji – https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
