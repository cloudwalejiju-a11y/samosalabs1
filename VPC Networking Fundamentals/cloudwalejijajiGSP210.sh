...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe our Channel:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo -e "${MAGENTA_TEXT}${BOLD_TEXT}Follow on Instagram:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.instagram.com/@cloudwalejijaji/${RESET_FORMAT}"
echo
