...
echo "Subscribe to Cloud Wale Jija Ji Channel" > sample.txt
...
echo -e "${GREEN_TEXT}${BOLD_TEXT}Check out our Channel: https://www.youtube.com/@cloudwalejijaji${RESET_FORMAT}"
