...
echo "${PURPLE_COLOR}${BOLD_TEXT}  WELCOME TO CLOUD WALE JIJU CLOUD TUTORIALS  ${RESET_FORMAT}"
echo "${PURPLE_COLOR}${BOLD_TEXT}=============================================${RESET_FORMAT}"
echo
...
echo "${MAROON_COLOR}${BOLD_TEXT}=================================================${RESET_FORMAT}"
echo
echo -e "${NAVY_COLOR}${BOLD_TEXT}Check out Cloud Wale Jiju's Channel: \e]8;;https://www.youtube.com/@cloudwalejijaji\e\\https://www.youtube.com/@cloudwalejijaji\e]8;;\e\\${RESET_FORMAT}"
echo