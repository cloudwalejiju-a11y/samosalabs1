...
echo -e "${BLUE}${BOLD}"
echo "╔════════════════════════════════════════════╗"
echo "║   🚀 Cloud Wale Jija Ji's Terraform LB Deployer  ║"
echo "╚════════════════════════════════════════════╝"
echo -e "${NC}"
echo -e "${YELLOW}📺 YouTube: https://youtube.com/@cloudwalejijaji${NC}"
...
echo "╚════════════════════════════════════════════╝"
echo -e "${NC}"
echo -e "${YELLOW}Thank you for using Cloud Wale Jija Ji's Terraform script!${NC}"
echo -e "${YELLOW}Don't forget to subscribe to my YouTube channel for more tutorials!${NC}"
echo -e "${BLUE}https://youtube.com/@cloudwalejijaji${NC}"
