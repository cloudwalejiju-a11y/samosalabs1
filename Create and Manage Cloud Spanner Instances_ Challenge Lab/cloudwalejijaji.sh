...
echo "${BG_MAGENTA}${BOLD}Starting Execution - Cloud Wale Jija Ji Cloud Tutorials${RESET}"
...
gcloud spanner instances create banking-ops-instance \
  ...
  --description="DrCloud Wale Jija JiTutorial" \
  --nodes=1
...
curl -LO https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/Create%20and%20Manage%20Cloud%20Spanner%20Instances_%20Challenge%20Lab/Customer_List_500.csv
...
# Completion message
echo "${BG_RED}${BOLD}Lab Completed Successfully - Cloud Wale Jija Ji Cloud Tutorials${RESET}"
echo "${BLUE}For more tutorials visit: https://www.youtube.com/@DrCloud Wale Jija JiCloudTutorials${RESET}"
