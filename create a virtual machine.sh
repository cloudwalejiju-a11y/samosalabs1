...
# Cloud Wale Jiju intro
echo -e "${GREEN}${BOLD} Welcome to  Cloud Wale Jiju Cloud${RESET}"
...
echo -e "${BLUE}Special thanks to Cloud Wale Jiju!${RESET}"
echo -e "${BOLD}Don't forget to Like, Share, and Subscribe https://www.youtube.com/@cloudwalejijaji!${RESET}"