...
curl -LO https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Publishing%20APIs%20with%20Apigee%20X/simplebank-spec.yaml
...
echo "${CYAN}${BOLD}Don't forget to subscribe to Cloud Wale Jija Ji Cloud Tutorial:${RESET}"
