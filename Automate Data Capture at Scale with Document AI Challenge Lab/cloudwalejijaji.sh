...
while [ "$deploy_success" = false ]; do
  if deploy_function; then
    echo "Function deployed successfully.. Welcome to Cloud Wale Jija Ji Cloud Tutorials"
    echo "Subscribe to Cloud Wale Jija Ji: https://www.youtube.com/@cloudwalejijaji/videos"
  deploy_success=true
  else
    echo "Deployment Retrying, please subscribe to Cloud Wale Jija Ji: https://www.youtube.com/@cloudwalejijaji/videos"
    sleep 10
  fi
done
