...
echo "${COLOR_CYAN}${BOLD}│         Welcome to Cloud Wale Jija Ji Cloud Tutorial           │${COLOR_RESET}"
echo "${COLOR_CYAN}${BOLD}└──────────────────────────────────────────────────────────────┘${COLOR_RESET}"
echo
...
echo "${COLOR_CYAN}${BOLD}https://www.youtube.com/@cloudwalejijaji/videos${COLOR_RESET}"
echo "${COLOR_MAGENTA}${BOLD}Cloud Wale Jija Ji - Cloud Solutions Expert${COLOR_RESET}"
echo
