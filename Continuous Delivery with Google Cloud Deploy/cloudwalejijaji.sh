...
# Cloud Wale Jija Ji Brand Colors
...
echo "╔═══════════════════════════════════════════════════╗"
echo "║                                                   ║"
echo "║           Cloud Wale Jija Ji Cloud Tutorials            ║"
echo "║                                                   ║"
echo "║  Comprehensive GCP Learning Resources             ║"
echo "║  YouTube: https://youtube.com/@cloudwalejijaji    ║"
echo "║                                                   ║"
echo "╚═══════════════════════════════════════════════════╝"
echo "${RESET_FORMAT}"
...
echo
echo "${DR_PURPLE}${BOLD_TEXT}💖 Enjoyed this tutorial? Consider subscribing to Cloud Wale Jija Ji Cloud Tutorials! 👇${RESET_FORMAT}"
echo "${DR_BLUE}${BOLD_TEXT}${UNDERLINE_TEXT}https://youtube.com/@cloudwalejijaji${RESET_FORMAT}"
echo
