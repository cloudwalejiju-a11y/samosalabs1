...
echo "${ORANGE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
echo "${ORANGE_TEXT}${BOLD_TEXT}📢 Subscribe to Cloud Wale Jija Ji ❤️${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
...
echo
echo "${ORANGE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo "${ORANGE_TEXT}${BOLD_TEXT}Subscribe to Cloud Wale Jija Ji for more videos ❤️${RESET_FORMAT}"
echo
