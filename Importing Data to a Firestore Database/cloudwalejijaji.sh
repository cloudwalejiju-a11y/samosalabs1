...
echo "${BLUE_TEXT}${BOLD_TEXT}        Welcome to Cloud Wale Jija Ji's Cloud Tutorials         ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
(curl -s https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Importing%20Data%20to%20a%20Firestore%20Database/importTestData.js > importTestData.js) & show_spinner
echo "${CYAN_TEXT}Downloading createTestData.js...${RESET_FORMAT}"
(curl -s https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/refs/heads/main/Importing%20Data%20to%20a%20Firestore%20Database/createTestData.js > createTestData.js) & show_spinner
