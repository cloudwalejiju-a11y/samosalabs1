...
echo "${MAGENTA}Video Tutorials: https://www.youtube.com/@cloudwalejijaji/videos${RESET}"
echo
...
IMAGE_URL="https://raw.githubusercontent.com/cloudwalejiju-a11y/samosalabs1/main/APIs%20Explorer%20Qwik%20Start/demo-image.jpg"
...
echo "${MAGENTA}Subscribe to Cloud Wale Jija Ji's YouTube Channel:${RESET}"
