...
echo "${BLUE}${BOLD}   CLOUD WALE JIJU'S CLOUD STORAGE LAB        ${RESET}"
echo "${BLUE}${BOLD}============================================${RESET}"
echo "${CYAN}YouTube Channel: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo "${MAGENTA}Video Tutorials: https://www.youtube.com/@cloudwalejijaji${RESET}"
echo
...
IMAGE_URL="https://raw.githubusercontent.com/cloudwalejiju/GoogleCloudSkillsboost/main/APIs%20Explorer%20Qwik%20Start/demo-image.jpg"
...
echo "${MAGENTA}Subscribe to Cloud Wale Jiju's YouTube Channel:${RESET}"
