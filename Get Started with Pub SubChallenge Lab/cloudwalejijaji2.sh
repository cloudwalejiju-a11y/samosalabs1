...
echo "${MAGENTA_TEXT}${BOLD_TEXT}     🚀 Welcome to Cloud Wale Jija Ji Cloud Tutorials – GCP Lab      ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==============================================================${RESET_FORMAT}"
echo
...
echo -e "${CYAN_TEXT}${BOLD_TEXT}📺 Don’t forget to subscribe to Cloud Wale Jija Ji on YouTube:${RESET_FORMAT} ${BLUE_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@cloudwalejijaji/videos${RESET_FORMAT}"
echo
