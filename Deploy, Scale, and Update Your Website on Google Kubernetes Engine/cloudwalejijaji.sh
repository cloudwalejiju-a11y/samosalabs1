...
# Welcome message
echo -e "${YELLOW}=============================================${NC}"
echo -e "${GREEN} Welcome to Cloud Wale Jija Ji Cloud Tutorials! ${NC}"
echo -e "${YELLOW}=============================================${NC}"
echo -e "${CYAN}Don't forget to subscribe to our YouTube channel:${NC}"
echo -e "${BLUE}https://www.youtube.com/@cloudwalejijaji/videos${NC}"
echo -e "${YELLOW}=============================================${NC}"
echo -e "\n"
...
echo -e "${CYAN}Thanks for following Cloud Wale Jija Ji Cloud Tutorials!${NC}"
